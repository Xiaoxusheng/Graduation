<template>
  <div class="main-container">
    ...
    <a-card :body-style="{ padding: '10px' }" class="mt-4" title="文章内容">
      <template #extra>
        <div class="flex">
          <a-space justify="end">
            <a-button size="small" type="primary" @click="getHtmlContent">获取HTML</a-button>
            <a-button size="small" status="warning" @click="getJsonContent">获取JSON</a-button>
          </a-space>
        </div>
      </template>
