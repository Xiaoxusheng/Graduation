      ...
      <a-col :span="12">
        ...
        >
          <a-space direction="vertical" style="width: 100%">
            <a-alert show-icon title="Info" type="info">
              Info 类型
            </a-alert>
            <a-alert show-icon title="success" type="success">
              Success 类型
            </a-alert>
            <a-alert show-icon title="warning" type="warning">
              Warning 类
            </a-alert>
            <a-alert show-icon title="error" type="error">
              Error 类
            </a-alert>
          </a-space>
        </a-card>
