<template>
  <a-card title="生成二维码">
    <a-row :gutter="[10, 10]" class="mt-4">
      <a-col :span="8">
        <a-card :body-style="{ padding: 0 }" :header-style="{ padding: '5px' }" title="带logo">
          <div class="text-center flex justify-center">
            <canvas id="logoCanvas" height="250" width="250"></canvas>
          </div>
        </a-card>
      </a-col>
      <a-col v-for="(item, index) of qrcodeList" :key="index" :span="8">
