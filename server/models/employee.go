...
type Employee struct {
	...
	Birthday     time.Time `gorm:"type:time not null unique; comment:'员工生日'" json:"age,omitempty"`
	...
	DepartmentId string    `gorm:"type:int unique; comment:部门id" json:"department_id,omitempty"`
	gorm.Model
}
