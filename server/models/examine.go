...
type Examine struct {
	...
	StartTime int64  `gorm:"type:datetime not null; comment:'开始时间'" json:"start_time,omitempty"`
	EndTime   int64  `gorm:"type:datetime not null; comment:'结束时间'" json:"end_time,omitempty"`
